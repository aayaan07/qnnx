  ...
  return (
    <div className="relative rounded-2xl border border-indigo-500/20 bg-[#0a081e]/60 backdrop-blur-xl p-6 md:p-7 flex flex-col gap-4 transition-all duration-300 hover:-translate-y-1.5 hover:border-indigo-400/60 hover:shadow-[0_20px_60px_rgba(99,102,241,0.2)] overflow-hidden">
      ...
      <div className="flex gap-4 items-start">
        <div
          className={`relative ${
            large ? "w-16 h-16 md:w-18 md:h-18" : "w-14 h-14"
          } rounded-xl overflow-hidden border-2 border-indigo-400/40 shrink-0`}
        >
          <Image
            src={person.image}
            alt={person.name}
...
export default function TeamSection() {
  return (
    <section
      id="team"
      className="relative px-4 md:px-6 py-20 max-w-6xl mx-auto z-10"
    >
      {/* Header */}
      <div className="text-center mb-16">
        ...
        <p className="text-slate-500 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
          World-class researchers and innovators building quantum-grade
          security.
        </p>
      </div>
