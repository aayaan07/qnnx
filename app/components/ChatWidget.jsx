...
export default function ChatWidget() {
  ...
  const sendMessage = async () => {
    ...
    const history = messages.filter((m) => m.text !== WELCOME_MESSAGE.text);
    ...
    try {
      ...
      const aiText =
        data.text || "Quantum interference detected. Please try again.";
        ...
        >
          ...
          <div
            style={{
              padding: "16px 18px",
              background:
                "linear-gradient(135deg, rgba(99,102,241,0.18) 0%, rgba(79,70,229,0.1) 100%)",
          ...
          >
            {messages.map((msg, idx) => {
              ...
              const textToShow =
                isAI && isLast && isTyping ? displayedText : msg.text;
                    ...
                    dangerouslySetInnerHTML={{
                      __html:
                        ...
                        (isAI && isLast && isTyping
                          ? '<span style="display:inline-block;width:2px;height:13px;background:#818cf8;margin-left:2px;vertical-align:middle;border-radius:1px;animation:qnnx-pulse 0.8s ease infinite"></span>'
                          : ""),
                    }}
                  />
                </div>
                  ...
                  {[0, 1, 2].map((i) => (
                    <span
                      ...
                      style={{
                        ...
                        background: "#818cf8",
                        display: "inline-block",
                        animation: `qnnx-pulse 1.2s ease-in-out ${
                          i * 0.2
                        }s infinite`,
                      }}
                    />
          ...
          >
            Powered by{" "}
            <strong style={{ color: "rgba(99,102,241,0.7)" }}>QNNX</strong> ·
            Quantum-Grade AI
          </div>
        </div>
      )}
